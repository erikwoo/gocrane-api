...
LDFLAGS := "-X github.com/erikwoo/gocrane-api/pkg/version.gitVersion=$(GIT_VERSION) \
                      -X github.com/erikwoo/gocrane-api/pkg/version.gitCommit=$(GIT_COMMIT_HASH) \
                      -X github.com/erikwoo/gocrane-api/pkg/version.gitTreeState=$(GIT_TREESTATE) \
                      -X github.com/erikwoo/gocrane-api/pkg/version.buildDate=$(BUILDDATE)"
